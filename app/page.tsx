...
import { BentoGrid, BentoGridItem } from '@/web/_components/custom/bento'
import { FallingLogos } from '@/web/_components/custom/falling-logos'
import { Scroller } from '@/web/_components/custom/scroller'
import { thirtyRandomSlugs } from '@/web/_lib/fake-data'

const AnalyticsChart = dynamic(
  () => import('@/web/_components/custom/analytics-chart'),
  {
    ssr: false,
  }
)
